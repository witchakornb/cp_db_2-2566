                  ...
                  <table class="min-w-full text-center text-sm font-light">
                    ...
                    <tbody>
                      <tr class="border-b dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap  px-6 py-4">BI000012</td>
                        <td class="whitespace-nowrap  px-6 py-4">2024/02/06 10:03</td>
                        <td class="whitespace-nowrap  px-6 py-4">125.50</td>
                        <td class="whitespace-nowrap  px-6 py-4">หมิว หมิว</td>
                        <td class="whitespace-nowrap  px-6 py-4">พ่อใหญ่แดง</td>
                        <td class="whitespace-nowrap  px-6 py-4">ซื้อไปใส่ต้นกล้วย</td>
