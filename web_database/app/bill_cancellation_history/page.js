...
export default function BillCancellationHistory() {
      ...
      <body>
        ...
        <div className="" style={{ width: '100%' }}>
          ...
          <div class="flex justify-between mx-4 mt-8">
            <div class="font-bold">ประวัติการยกเลิกบิล</div>
            {/* <div class="">
              <div class="ps-4">
                <button class="bg-[#00A84F] hover:bg-[#008B41] text-white font-bold py-2 px-4 rounded inline-flex items-center">
                  ...
                  <table class="min-w-full text-center text-sm font-light">
                    ...
                    <tbody>
                      <tr class="border-b dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap  px-6 py-4">BI000055</td>
                        <td class="whitespace-nowrap  px-6 py-4">2024/02/08 15:04</td>
                        <td class="whitespace-nowrap  px-6 py-4">841.25</td>
                        <td class="whitespace-nowrap  px-6 py-4">เพชร เพชร</td>
                        <td class="whitespace-nowrap  px-6 py-4">แม่ใหญ่ศรี</td>
                        <td class="whitespace-nowrap  px-6 py-4">ซื้อไปใส่ต้นพริกระยะเติบโต</td>
