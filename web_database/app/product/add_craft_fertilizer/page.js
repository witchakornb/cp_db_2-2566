...
import "./add_craft_fertilizer.css";
      ...
      <body>
        <div class="p-10 pt-4 mx-auto">
          ...
          "/>
            ...
            <div class="inline-block items-center mb-5 relative">
              <label for="number" class="inline-block w-40 mr-1 text-left 
                            text-black">ปริมาณ</label>
              <input type="number" id="number" name="number" placeholder="กรอกปริมาณ"
                class="w-1/6 rounded-md border border-[#e0e0e0] bg-white py-2 px-3 text-base text-[#737373] outline-none focus:border-[#6A64F1] focus:shadow-md
          "/>
              {/* <label for="number" class="text-black">กิโลกรัม</label> */}
              {/* <div class="rounded-md absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                <label for="number" class="text-black">กิโลกรัม</label>
              </div> */}
            </div>
