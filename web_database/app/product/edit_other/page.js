            ...
            <form action="#">
              ...
              <div className="flex items-center mb-5">
                <label for="name" className="inline-block w-40 mr-6 text-left 
                            text-black">ชื่อสินค้า</label>
                <input type="text" id="name" name="name" placeholder="กรอกชื่อสินค้า"
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-3 text-base text-[#737373] outline-none focus:border-[#6A64F1] focus:shadow-md
                  "/>
              </div>
              <div className="flex items-center mb-5">
                <label for="name" className="inline-block w-40 mr-6 text-left 
                            text-black">ประเภทของสินค้า</label>
                <input type="text" id="name" name="name" placeholder="กรอกประเภทของสินค้า"
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-3 text-base text-[#737373] outline-none focus:border-[#6A64F1] focus:shadow-md
                  "/>
              </div>
              <div className="flex items-center mb-5">
                <label for="name" className="inline-block w-40 mr-6 text-left 
                            text-black">ขนาดของสินค้า</label>
                <input type="text" id="name" name="name" placeholder="กรอกขนาดของสินค้า"
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-3 text-base text-[#737373] outline-none focus:border-[#6A64F1] focus:shadow-md
                  "/>
              </div>
