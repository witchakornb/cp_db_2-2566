...
export default function Tsidebar(){
  ...
  // Use useEffect to check if the code is running on the client side
  useEffect(() => {
  ...
  return (
    ...
    <html lang="en">
      ...
      <body>
        <nav className="p-4 flex items-center justify-between" style={{ background: '#333333' }}>
          ...
          <button className="hover:bg-gray-300 text-gray-200 font-bold py-2 px-4 rounded inline-flex items-center" style={{ background: '#FFFFFF' ,color:'#333333'}}>
