        ...
        const fetchData = async () => {
            try {
                ...
                const optionsCustomerId = posts.map((item) => (
                    <option key={item.ImportId} value={item.ImportId}></option>
                ));
                ...
                const optionsCustomerName = posts.map((item) => (
                    <option key={item.ImportId} value={item.CustomerName}></option>
                ));
    ...
    const filterSalesData = () => {
        if (searchButtonClicked) {
            ...
            const filteredData = posts.filter((sale) => {
                const inputCustomerIDMatch = !InputcustomerID || sale.ImportId.includes(InputcustomerID);
                // Extracting the date part from the API response
                const apiDate = sale.ImportDate.split(' ')[0];
                                ...
                                <div class="flex -mx-2">
                                        ...
                                        <div class="h-12">
                                            <div class="mb-4">
                                                <form action="" method="get">
                                                    <label for="customerID">ค้นหาใบนำเข้า</label>
                                                    <input
                                    ...
                                    <div class="w-1/2 px-2">
                                        <div class="h-12">
                                            <div class="mb-4">
                                                <form action="" method="get">
                                                    <label for="InputDate">วันที่นำเข้า</label>
                                                    <input
                                                        value={InputDate}
